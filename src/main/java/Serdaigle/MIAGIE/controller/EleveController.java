...
public class EleveController {
    ...
    /**
     * Constructeur du controleur Eleve
     *  Ce controleur expose des endpoints pour effectuer diverses opérations sur les élèves et les parties de jeu.
     *
     * @param ecoleService Le service principal de gestion de l'école.
     * @param chiFouMiService Le service de gestion des parties de jeu.
     */
